...
@WebServlet(name = "TatCaDonHangServlet", value = "/TatCaDonHang")
public class TatCaDonHangServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (user != null) {
            ...
            if (status != null && status.equals("all")) {
                orders = dao.dsOrderOfCus(customer.getCustomerID());
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("TatCaDonHang.jsp");
