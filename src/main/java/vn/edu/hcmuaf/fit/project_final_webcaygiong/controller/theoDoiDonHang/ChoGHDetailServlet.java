...
@WebServlet(name = "ChoGHDetailServlet", value = "/ChoGHDetail")
public class ChoGHDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (user != null) {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("ChoGiaoHangDetail.jsp");
