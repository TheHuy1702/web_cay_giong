...
@WebServlet(name = "ChoXNDetailServlet", value = "/ChoXNDetail")
public class ChoXNDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (user != null) {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("ChoXacNhanDetail.jsp");
